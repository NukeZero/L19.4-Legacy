...
void CWndRainbowRaceRanking::OnDraw( C2DRender* p2DRender ) 
{
	...
	for(int i=0; i<5; i++)
	{
...
#if __VER >= 19
		m_p2DRender->TextOut( 30, 55 + nTextGap, strTemp, 0xffffffff );
#else // __VER >= 19
		m_p2DRender->TextOut( 30, 55 + nTextGap, strTemp, 0xff000000 );
#endif // __VER >= 19
		...
		if(m_dwPlayerId[i] != 0 && pPlayerData && strlen(pPlayerData->szPlayer) > 0)
		{
			...
			// Draw Text Name.		
#if __VER >= 19
			m_p2DRender->TextOut( 80, 55 + nTextGap, pPlayerData->szPlayer, 0xffffffff );
#else // __VER >= 19
			m_p2DRender->TextOut( 80, 55 + nTextGap, pPlayerData->szPlayer, 0xff000000 );
#endif // __VER >= 19
