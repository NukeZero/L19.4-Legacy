...
#define	PACKETTYPE_COLOSSEUM						(DWORD)0xAA000001
#define	PACKETTYPE_BARUNA							(DWORD)0xAA000002
#define PACKETTYPE_COMBINE_FASHION					(DWORD)0xAA000003
#define PACKETTYPE_ITEMLINK							(DWORD)0xAA000004
#define PACKETTYPE_LINKEDITEM						(DWORD)0xAA000005
#define PACKETTYPE_OPENBOX							(DWORD)0xAA000006
#define PACKETTYPE_OPENCOUPON						(DWORD)0xAA000007
#define PACKETTYPE_EXCHANGECOUPON					(DWORD)0xAA000008
#define	PACKETTYPE_SCROLLTASKBAR					(DWORD)0xAA000009

//|: ~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-

#define	SNAPSHOTTYPE_COLOSSEUM_ENTER				(WORD)0x8901
#define	SNAPSHOTTYPE_COLOSSEUM_START				(WORD)0x8902
#define	SNAPSHOTTYPE_COLOSSEUM_ENDWAIT				(WORD)0x8903
#define	SNAPSHOTTYPE_COLOSSEUM_READY1				(WORD)0x8904
#define	SNAPSHOTTYPE_COLOSSEUM_READY2				(WORD)0x8905
#define	SNAPSHOTTYPE_COLOSSEUM_ENDMATCH				(WORD)0x8906
#define SNAPSHOTTYPE_LINKEDITEM						(WORD)0x8907
#define SNAPSHOTTYPE_ITEMLINK						(WORD)0x8908
#define SNAPSHOTTYPE_ADDBARUNAPET					(WORD)0x8909
#define	SNAPSHOTTYPE_SETSLEEP						(WORD)0x8910
#define	SNAPSHOTTYPE_SENDTREASURE					(WORD)0x8911
#define	SNAPSHOTTYPE_GETCOUPON						(WORD)0x8912
