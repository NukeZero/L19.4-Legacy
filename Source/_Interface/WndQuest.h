...
#if __VER >= 19
							  DWORD dwStartColor = D3DCOLOR_ARGB( 255, 255, 255, 255 ),
							  DWORD dwEndColor = D3DCOLOR_ARGB( 255, 255, 255, 255 ), 
							  DWORD dwSelectColor =  D3DCOLOR_ARGB( 255, 255, 255, 255 ) );
const CString MakeString( const CString& string, BOOL bCond );
DWORD MakeTextColor( DWORD dwStartColor = D3DCOLOR_ARGB( 255, 255, 255, 255 ), DWORD dwEndColor = D3DCOLOR_ARGB( 255, 255, 255, 255 ), int nCurrentNumber = 0, int nCompleteNumber = 0 );
#else // __VER >= 19
