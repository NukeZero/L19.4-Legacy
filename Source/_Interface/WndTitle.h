...
public:
	...
	void AfterSkinTexture( LPWORD pDest, CSize size, D3DFORMAT d3dFormat = D3DFMT_A16B16G16R16 );
#else
...
#ifdef __SECURITY_FIXES
	virtual void AdditionalSkinTexture( LPWORD pDest, CSize sizeSurface, D3DFORMAT d3dFormat = D3DFMT_A16B16G16R16 );
#else
