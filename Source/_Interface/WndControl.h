...
#if __VER >= 16
	BOOL Create( LPCTSTR lpszCaption, DWORD dwStyle, const RECT& rect, CWndBase* pParentWnd, UINT nID, int nRed = 255, int nGreen = 255, int nBlue = 255 );
#else // __VER >= 16
...
#ifdef __ITEMLINK
	void BlockSetItemLink( DWORD dwUserId,DWORD dwObjId );
#endif	
...
#ifdef __ITEMLINK
#if __VER >= 19
	void SetString( LPCTSTR pszString, DWORD dwColor = 0xffffffff, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	void AddString( LPCTSTR pszString, DWORD dwColor = 0xffffffff, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void SetString( LPCTSTR pszString, DWORD dwColor = 0xff000000, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	void AddString( LPCTSTR pszString, DWORD dwColor = 0xff000000, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#else // __ITEMLINK
#if __VER >= 19
	void SetString( LPCTSTR pszString, DWORD dwColor = 0xffffffff );
	void AddString( LPCTSTR pszString, DWORD dwColor = 0xffffffff, DWORD dwPStyle = 0x00000001 );
#else // __VER >= 19
...
public:
	...
	LPTREEELEM InsertItem( LPTREEELEM lpParent, 
						   ...
						   DWORD dwSelectColor = D3DCOLOR_ARGB( 255, 0, 255, 255 ));
#else // __VER >= 19
