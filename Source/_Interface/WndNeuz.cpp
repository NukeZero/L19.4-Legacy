...
void CWndTitleBar::OnInitialUpdate()
{
	...
	{
#if __VER >= 19
		m_awndButton[ WTBID_PIN - 10000 ].Create( _T( "" ), 0, CRect( m_nButtonMax * 16, 6, m_nButtonMax * 16 + 16, 25), this, WTBID_PIN ), m_nButtonMax++;
#else // __VER >= 19
	...
	{
#if __VER >= 19
		m_awndButton[ WTBID_REPORT - 10000 ].Create( _T( "" ), 0, CRect( m_nButtonMax * 16, 6, m_nButtonMax * 16 + 16, 25), this, WTBID_REPORT ), m_nButtonMax++;
#else // __VER >= 19
	...
	{
#if __VER >= 19
		m_awndButton[ WTBID_EXTENSION - 10000 ].Create( _T( "" ), WBS_CHECK | WBS_PUSHLIKE , CRect( m_nButtonMax * 16, 5, m_nButtonMax * 16 + 16, 25), this, WTBID_EXTENSION ), m_nButtonMax++;
#else // __VER >= 19
	...
	{
#if __VER >= 19
		m_awndButton[ WTBID_HELP - 10000 ].Create( _T( "" ), 0, CRect( m_nButtonMax * 16, 6 , m_nButtonMax * 16 + 16, 25), this, WTBID_HELP ), m_nButtonMax++;
#else // __VER >= 19
...
//#endif
	...
	{
#if __VER >= 19
		m_awndButton[ WTBID_MIN - 10000 ].Create( _T( "" ), 0, CRect( m_nButtonMax * 16, 6 , m_nButtonMax* 16 + 16, 25), this, WTBID_MIN ), m_nButtonMax++;
#else // __VER >= 19
	...
	{
#if __VER >= 19
		m_awndButton[ WTBID_MAX - 10000 ].Create( _T( "" ), 0, CRect( m_nButtonMax * 16, 6 , m_nButtonMax* 16 + 16, 25), this, WTBID_MAX ), m_nButtonMax++;
#else // __VER >= 19
...
//#endif
	...
	if(m_pParentWnd->IsWndStyle( WBS_CAPTION ) )
	{
		...
		{
#if __VER >= 19
			m_awndButton[ WTBID_CLOSE - 10000 ].Create( _T( "" ), 0, CRect( m_nButtonMax * 16, 6, m_nButtonMax * 16 + 16, 25), this, WTBID_CLOSE ), m_nButtonMax++;
#else // __VER >= 19
...
#if __VER >= 19
	CRect rect( 0, 6, m_nButtonMax * 16, 26 ); 
#else // __VER >= 19
...
CWndBase* CWndNeuz::CreateControl( HWND hWnd, LPWNDCTRL lpWndCtrl ) 
{
...
#if __VER >= 16
		((CWndText*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#endif // __VER >= 16
	...
	case WTYPE_STATIC:
		...
		((CWndStatic*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#else // __VER >= 16
...
#if __VER >= 16
		((CWndEdit*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#endif // __VER >= 16
	...
	case WTYPE_LISTBOX:
		...
		//((CWndButton*)pWndBase)->Create( _T( "Button" ), 0, CRect( 0, 0, 100, 20), &m_dialogWnd, 10 );
#if __VER >= 16
		((CWndListBox*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#endif // __VER >= 16
	...
	case WTYPE_LISTCTRL:
		...
		//((CWndButton*)pWndBase)->Create( _T( "Button" ), 0, CRect( 0, 0, 100, 20), &m_dialogWnd, 10 );
#if __VER >= 16
		((CWndListCtrl*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#endif // __VER >= 16
...
#if __VER >= 16
		((CWndComboBox*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#endif // __VER >= 16
	...
	case WTYPE_TREECTRL:
		...
		//((CWndButton*)pWndBase)->Create( _T( "Button" ), 0, CRect( 0, 0, 100, 20), &m_dialogWnd, 10 );
#if __VER >= 16
		((CWndTreeCtrl*)pWndBase)->m_dwColor = D3DCOLOR_XRGB( lpWndCtrl->m_nRed, lpWndCtrl->m_nGreen, lpWndCtrl->m_nBlue );
#endif // __VER >= 16
		if( lpWndCtrl->strTexture.IsEmpty() == FALSE )
			((CWndStatic*)pWndBase)->m_strTexture = lpWndCtrl->strTexture;
		pWndBase->m_bTile = (lpWndCtrl->bTile != FALSE);
