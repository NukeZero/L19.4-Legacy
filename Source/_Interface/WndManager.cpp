...
//	dwItemColor[FIRST_TC].dwName0				= D3DCOLOR_XRGB(  12, 144, 231 );
	...
	dwItemColor[FIRST_TC].dwName1				= D3DCOLOR_XRGB( 172, 220, 101 );
	dwItemColor[FIRST_TC].dwName2				= D3DCOLOR_XRGB( 128,  64,   0 );
#else // __VER >= 19
...
#endif // __VER >= 19
//	dwItemColor[FIRST_TC].dwName2				= D3DCOLOR_XRGB( 182,   0, 255 );			// ?? 2??
#if __VER >= 19
	dwItemColor[FIRST_TC].dwName3				= D3DCOLOR_XRGB(255, 70, 170);			// ?? 3??
#else // __VER >= 19
#if __VER >= 9 // __CSC_VER9_1
	dwItemColor[FIRST_TC].dwName3 				= D3DCOLOR_XRGB(127, 0, 255);			// ?? 3??
#else // __CSC_VER9_1
	dwItemColor[FIRST_TC].dwName3				= D3DCOLOR_XRGB(0, 0, 255);			// ?? 3??
#endif // __CSC_VER9_1
#endif // __VER >= 19
#ifdef __NEW_ITEM_VARUNA
	dwItemColor[FIRST_TC].dwName4				= D3DCOLOR_XRGB( 255,  64,  39 );			// 이름 4단계
#else // __NEW_ITEM_VARUNA
	dwItemColor[FIRST_TC].dwName4				= D3DCOLOR_XRGB(   0,   0, 255 );			// 이름 4단계
#endif // __NEW_ITEM_VARUNA
	dwItemColor[FIRST_TC].dwName5				= D3DCOLOR_XRGB(   0,   0, 255 );			// ?? 5??
#if __VER >= 19
	dwItemColor[FIRST_TC].dwGeneral				= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwPlusOption			= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwPiercing			= D3DCOLOR_XRGB( 211, 134, 255 );
	dwItemColor[FIRST_TC].dwResist				= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwResistFire			= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwResistWater			= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwResistEarth			= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwResistElectricity	= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwResistWind			= D3DCOLOR_XRGB( 255, 255, 255 );
	
	dwItemColor[FIRST_TC].dwResistSM			= D3DCOLOR_XRGB(   0, 158,   0 );			// ?? ??? ??
	dwItemColor[FIRST_TC].dwResistSM1			= D3DCOLOR_XRGB( 255,   0,   0 );			// ?? ??? ???
	dwItemColor[FIRST_TC].dwTime				= D3DCOLOR_XRGB(   0,   200,   0 );			// ?? ? ??
	dwItemColor[FIRST_TC].dwEffective0			= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwEffective1			= D3DCOLOR_XRGB(   0, 255,   0 );			// ??? ??1
	dwItemColor[FIRST_TC].dwEffective2			= D3DCOLOR_XRGB( 255,   0,   0 );			// ??? ??2
	dwItemColor[FIRST_TC].dwEffective3			= D3DCOLOR_XRGB( 128, 128, 128 );			// ??? ??3
	dwItemColor[FIRST_TC].dwRandomOption		= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwEnchantOption		= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwSetName				= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwSetItem0			= D3DCOLOR_XRGB( 178, 178, 178 );			// ?? ??(????)
	dwItemColor[FIRST_TC].dwSetItem1			= D3DCOLOR_XRGB(   1, 171,  25 );
	dwItemColor[FIRST_TC].dwSetEffect			= D3DCOLOR_XRGB( 255, 157,   0 );			// ?? ??
	dwItemColor[FIRST_TC].dwGold				= D3DCOLOR_XRGB( 255, 255, 255 );
	dwItemColor[FIRST_TC].dwCommand				= D3DCOLOR_XRGB( 255, 255, 255 );
#else // __VER >= 19
	dwItemColor[FIRST_TC].dwGeneral				= D3DCOLOR_XRGB(   0,   0,   0 );			// ??
	dwItemColor[FIRST_TC].dwPlusOption			= D3DCOLOR_XRGB(   0,   0,   0 );			// ??? ??
	dwItemColor[FIRST_TC].dwPiercing			= D3DCOLOR_XRGB( 178,   0, 255 );			// ???
	dwItemColor[FIRST_TC].dwResist				= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ??
	dwItemColor[FIRST_TC].dwResistFire			= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ?
	dwItemColor[FIRST_TC].dwResistWater			= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ?
	dwItemColor[FIRST_TC].dwResistEarth			= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ?
	dwItemColor[FIRST_TC].dwResistElectricity	= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ??
	dwItemColor[FIRST_TC].dwResistWind			= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ??
	dwItemColor[FIRST_TC].dwResistSM			= D3DCOLOR_XRGB(   0, 158,   0 );			// ?? ??? ??
	dwItemColor[FIRST_TC].dwResistSM1			= D3DCOLOR_XRGB( 255,   0,   0 );			// ?? ??? ???
	dwItemColor[FIRST_TC].dwTime				= D3DCOLOR_XRGB(   0,   200,   0 );			// ?? ? ??
	dwItemColor[FIRST_TC].dwEffective0			= D3DCOLOR_XRGB(   0,   0,   0 );			// ??? ??
	dwItemColor[FIRST_TC].dwEffective1			= D3DCOLOR_XRGB(   0, 255,   0 );			// ??? ??1
	dwItemColor[FIRST_TC].dwEffective2			= D3DCOLOR_XRGB( 255,   0,   0 );			// ??? ??2
	dwItemColor[FIRST_TC].dwEffective3			= D3DCOLOR_XRGB( 128, 128, 128 );			// ??? ??3
	dwItemColor[FIRST_TC].dwRandomOption		= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ??
	dwItemColor[FIRST_TC].dwEnchantOption		= D3DCOLOR_XRGB(   0,   0,   0 );			// ??? ??
	dwItemColor[FIRST_TC].dwSetName				= D3DCOLOR_XRGB(   0,   0,   0 );			// ?? ??
	dwItemColor[FIRST_TC].dwSetItem0			= D3DCOLOR_XRGB( 178, 178, 178 );			// ?? ??(????)
	dwItemColor[FIRST_TC].dwSetItem1			= D3DCOLOR_XRGB(   0,   75, 255 );			// ?? ??(???)
	dwItemColor[FIRST_TC].dwSetEffect			= D3DCOLOR_XRGB( 255, 157,   0 );			// ?? ??
...
#if __VER >= 9 // __CSC_VER9_1
	dwItemColor[FIRST_TC].dwAddedOpt1			= D3DCOLOR_XRGB( 127, 255,   0 );			//??? ?? ?? ?? "??? ??"
	dwItemColor[FIRST_TC].dwAddedOpt2			= D3DCOLOR_XRGB(   0, 255, 255 );			//??? ?? ?? ?? "??? ??"
	dwItemColor[FIRST_TC].dwAddedOpt3			= D3DCOLOR_XRGB( 140,  23,  23 );			//??? ?? ?? ?? "??"
	dwItemColor[FIRST_TC].dwAddedOpt4			= D3DCOLOR_XRGB( 255, 127,   0 );			//??? ?? ?? ?? "?? ??? ??"
	dwItemColor[FIRST_TC].dwAddedOpt5			= D3DCOLOR_XRGB( 255, 110, 199 );			//??? ?? ?? ?? "PvP ??? ??"
	dwItemColor[FIRST_TC].dwAddedOpt6			= D3DCOLOR_XRGB( 205, 127,  50 );			//??? ?? ?? ?? "? ??"
	dwItemColor[FIRST_TC].dwAddedOpt7			= D3DCOLOR_XRGB( 255,   0,   0 );			//??? ?? ?? ?? "?? ??"
	dwItemColor[FIRST_TC].dwAddedOpt8			= D3DCOLOR_XRGB(  50,  50, 255 );			//??? ?? ?? ?? "?? ??"
	...
	dwItemColor[FIRST_TC].dwBlessing	= D3DCOLOR_XRGB(   97,   97, 255 );
#else // __VER >= 19
	...
	dwItemColor[SECOND_TC].dwResistFire			= D3DCOLOR_XRGB( 230,   0,   0 );			// ?? ?
	dwItemColor[SECOND_TC].dwResistWater		= D3DCOLOR_XRGB(   0,   0, 182 );			// ?? ?
	dwItemColor[SECOND_TC].dwResistEarth		= D3DCOLOR_XRGB( 185, 118,   0 );			// ?? ?
	dwItemColor[SECOND_TC].dwResistElectricity	= D3DCOLOR_XRGB(  21,  55, 152 );			// ?? ??
	dwItemColor[SECOND_TC].dwResistWind			= D3DCOLOR_XRGB(   0, 217, 214 );			// ?? ??
	dwItemColor[SECOND_TC].dwTime				= D3DCOLOR_XRGB( 146,   0,  38 );			// ?? ? ??
	dwItemColor[SECOND_TC].dwPlusOption			= D3DCOLOR_XRGB( 199, 155,   0 );			// ??? ??
	dwItemColor[SECOND_TC].dwPiercing			= D3DCOLOR_XRGB(  77,  11, 145 );			// ???
	dwItemColor[SECOND_TC].dwRandomOption		= D3DCOLOR_XRGB( 199, 155,   0 );			// ?? ??
	dwItemColor[SECOND_TC].dwSetName			= D3DCOLOR_XRGB(  50, 178,   0 );			// ?? ??
	dwItemColor[SECOND_TC].dwSetItem0			= D3DCOLOR_XRGB( 178, 178, 178 );			// ?? ??(????)
	dwItemColor[SECOND_TC].dwSetItem1			= D3DCOLOR_XRGB( 114, 186,  85 );			// ?? ??(???)
	dwItemColor[SECOND_TC].dwSetEffect			= D3DCOLOR_XRGB(  50, 178,   0 );			// ?? ??
	dwItemColor[SECOND_TC].dwCommand			= D3DCOLOR_XRGB( 199, 155,   0 );			// ??
#if __VER >= 11 // __SYS_IDENTIFY
#if __VER >= 12 // __EXT_PIERCING
#if __VER >= 19
	dwItemColor[SECOND_TC].dwAwakening	= D3DCOLOR_XRGB( 97,   97, 255 );			// 아이템 각성
	dwItemColor[SECOND_TC].dwBlessing	= D3DCOLOR_XRGB( 97,   97, 255 );			// 여신의 축복
#else // __VER >= 19
...
#ifdef __NEW_TASKBAR_V19
	ObjectExecutor( SHORTCUT_APPLET, APP_NEWTASKBAR04 );
	ObjectExecutor( SHORTCUT_APPLET, APP_NEWTASKBAR03 );
...
#endif //__GUILD_HOUSE
#if __VER >= 19
								&& pWndBase->GetWndApplet()->dwWndId != APP_CHAT_LOG
#endif // __VER >= 19
#ifdef __NEW_TASKBAR_V19
								&& pWndBase->GetWndApplet()->dwWndId != APP_NEWTASKBAR
...
//		}
		...
		if( g_Option.m_nInterface == 2 )
		{
			...
			{
				g_bKeyTable[ '1' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 0 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '2' ] )
			{
				g_bKeyTable[ '2' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 1 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '3' ] )
			{
				g_bKeyTable[ '3' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 2 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '4' ] )
			{
				g_bKeyTable[ '4' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 3 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '5' ] )
			{
				g_bKeyTable[ '5' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 4 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '6' ] )
			{
				g_bKeyTable[ '6' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 5 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '7' ] )
			{
				g_bKeyTable[ '7' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 6 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '8' ] )
			{
				g_bKeyTable[ '8' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 7 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '9' ] )
			{
				g_bKeyTable[ '9' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 8 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
			if( g_bKeyTable[ '0' ] )
			{
				g_bKeyTable[ '0' ] = 0;
				pShortcut = m_pWndTaskBar_HUD->m_pSlotItem[ 9 ];
				g_WndMng.ObjectExecutor( pShortcut );
			}
...
#ifdef __ITEMLINK
				str.Format("\n [Press ctrl & click to link the item.]");
				pEdit->AddString( str, 0xffc0c0c0);
#endif
}
#endif	// __SYS_IDENTIFY
...
#if __VER >= 19
			pEdit->AddString( strTemp, 0xFFFFEAA1 );
#else // __VER >= 19
			pEdit->AddString( strTemp, dwItemColor[g_Option.m_nToolTipText].dwGeneral );
#endif // __VER >= 19
		}
...
#if __VER >= 19
		string.Format( "#b#cfff6cc4d%s#nc#nb", g_Neuz.m_apPlayer[SelectCharacter]->GetName() );
#else // __VER >= 19
...
#if __VER >= 19
		str.AddString(strTemp, D3DCOLOR_XRGB( 97, 97, 255 ) );
#else // __VER >= 19
...
#if __VER >= 19
	pEdit->AddString( strEdit, 0xffffffff, ESSTY_BOLD );
#else // __VER >= 19
