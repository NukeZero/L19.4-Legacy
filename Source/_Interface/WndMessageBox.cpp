...
void CWndMessageBox::OnInitialUpdate()
{
	...
	switch(m_nType)
	{
		...
		case MB_OK:
#if __VER >= 19
			m_wndButton1.Create(prj.GetText( TID_MMI_UIBUTTON_BUTTON02 ), 0, rect1_1, this, IDOK);
		...
		case MB_CANCEL:
#if __VER >= 19
			m_wndButton1.Create(prj.GetText( TID_MMI_UIBUTTON_BUTTON03 ), 0, rect1_1, this, IDCANCEL);
			m_wndButton1.SetTexture(m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "ButtNormal00.tga"));
#else // __VER >= 19
		...
		case MB_OKCANCEL:
#if __VER >= 19
			m_wndButton1.Create(prj.GetText( TID_MMI_UIBUTTON_BUTTON02 ), 0, rect2_1, this, IDOK    );
			m_wndButton2.Create(prj.GetText( TID_MMI_UIBUTTON_BUTTON03 ), 0, rect2_2, this, IDCANCEL);
			m_wndButton1.SetTexture(m_pApp->m_pd3dDevice, MakePath( DIR_THEME, "ButtNormal00.tga"));
...
#if __VER >= 19
	m_wndText.SetString( lpszMessage, 0xffffffff );
#else // __VER >= 19
...
void CWndMessageBoxUpper::OnInitialUpdate()
{
	...
	switch(m_nType)
	{
		...
		case MB_RETRYCANCEL:
			m_wndButton1.Create("재시도", 0, rect2_1, this, IDRETRY );
#if __VER >= 19
			m_wndButton3.Create(prj.GetText( TID_MMI_UIBUTTON_BUTTON03 ),0, rect3_3,this,IDCANCEL);//,m_pSprPack,9);
#else // __VER >= 19
			m_wndButton2.Create("CANCEL", 0, rect2_2, this, IDCANCEL);
#endif // __VER >= 19
			break;
		case MB_YESNO:
#if __VER >= 19
			m_wndButton1.Create(prj.GetText( TID_GAME_YES ),0, rect2_1,this,IDYES);
			m_wndButton2.Create(prj.GetText( TID_GAME_NO ),0, rect2_2,this,IDNO );
#else // __VER >= 19
			m_wndButton1.Create("예"    ,0, rect2_1,this,IDYES);
			m_wndButton2.Create("아니오",0, rect2_2,this,IDNO );
#endif // __VER >= 19
		...
		case MB_YESNOCANCEL:
#if __VER >= 19
			m_wndButton1.Create(prj.GetText( TID_GAME_YES ),0, rect3_1,this,IDYES);//   ,m_pSprPack,9);
			m_wndButton2.Create(prj.GetText( TID_GAME_NO ),0, rect3_2,this,IDNO);//    ,m_pSprPack,9);
			m_wndButton3.Create(prj.GetText( TID_MMI_UIBUTTON_BUTTON03 ),0, rect3_3,this,IDCANCEL);//,m_pSprPack,9);
#else // __VER >= 19
			m_wndButton1.Create("예"    ,0, rect3_1,this,IDYES);//   ,m_pSprPack,9);
			m_wndButton2.Create("아니오",0, rect3_2,this,IDNO);//    ,m_pSprPack,9);
