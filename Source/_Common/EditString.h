...
public:
...
#ifdef __ITEMLINK
	CDWordArray m_adwPlayerId;
	CDWordArray m_adwObjId;
#endif
...
#ifdef __ITEMLINK
	void ParsingString( LPCTSTR lpsz, DWORD dwColor, DWORD dwStyle, WORD wCodePage, CString& string, CDWordArray& adwColor, CByteArray& abyStyle, CWordArray& awCodePage, CDWordArray& adwPlayerId, CDWordArray& adwObjId, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else
...
#ifdef __ITEMLINK
	void SetItemLink( int nPos, int nLength, DWORD dwPlayerId, DWORD dwObjId );
	void SetItemLink( DWORD dwPlayerId, DWORD dwObjId );
#endif
...
#ifdef __ITEMLINK
#if __VER >= 19
	int Insert( int nIndex, TCHAR ch, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	int Insert( int nIndex, LPCTSTR pstr, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	int Insert( int nIndex, TCHAR ch, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	int Insert( int nIndex, LPCTSTR pstr, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#else // __ITEMLINK
#if __VER >= 19
...
#ifdef __ITEMLINK
#if __VER >= 19
	void SetAt( int nIndex, TCHAR ch, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void SetAt( int nIndex, TCHAR ch, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#else // __ITEMLINK
#if __VER >= 19
...
#ifdef __ITEMLINK
#if __VER >= 19
	void AddParsingString( LPCTSTR lpsz, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void AddParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#else // __ITEMLINK
#if __VER >= 19
...
#if __VER >= 15 // __IMPROVE_QUEST_INTERFACE
#if __VER >= 19
	void SetParsingString( LPCTSTR lpsz, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPStyle = 0x00000001, BOOL bNoInitAlign = FALSE, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void SetParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPStyle = 0x00000001, BOOL bNoInitAlign = FALSE, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#else // __IMPROVE_QUEST_INTERFACE
#if __VER >= 19
	void SetParsingString( LPCTSTR lpsz, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void SetParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPStyle = 0x00000001, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#endif // __IMPROVE_QUEST_INTERFACE
#else // __ITEMLINK
#if __VER >= 15 // __IMPROVE_QUEST_INTERFACE
...
#else // __ITEMLINK
#if __VER >= 19
	void AddString( LPCTSTR lpsz, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	void AddString( char ch, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void AddString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	void AddString( char ch, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#endif // __ITEMLINK
#ifndef __ITEMLINK
#if __VER >= 19
	...
	void SetString( char* lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0 );
#endif // __VER >= 19
#else // __ITEMLINK
#if __VER >= 19
	void SetString( LPCTSTR lpsz, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	void SetString( char* lpsz, DWORD dwColor = 0xffffffff, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#else // __VER >= 19
	void SetString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
	void SetString( char* lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0, DWORD dwPlayerId = 0, DWORD dwObjId = 0 );
#endif // __VER >= 19
#endif // __ITEMLINK
...
#ifdef __ITEMLINK
	BOOL IsItemLink( int nIdx ){ return (m_adwPlayerId.GetAt( nIdx ) != 0); };
#endif // __ITEMLINK
};
