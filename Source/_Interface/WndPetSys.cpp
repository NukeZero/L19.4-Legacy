...
#if __VER >= 19
			m_p2DRender->TextOut( point.x + 36 - size.cx, point.y + 48 - size.cy, szTemp, 0xFF000000 );
			m_p2DRender->TextOut( point.x + 35 - size.cx, point.y + 47 - size.cy, szTemp, 0xFF85FF8A );
#else // __VER >= 19
...
#if __VER >= 19
	m_wndText.SetString( m_strText, 0xffffffff );
#else // __VER >= 19
