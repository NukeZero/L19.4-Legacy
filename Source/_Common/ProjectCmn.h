...
const int	MAX_PROPMOVER =		14900;		// MoverProp배열의 최대갯수 
...
#if __VER >= 19
	DWORD	dwDestParam[6];		// 적용대상1	
	LONG	nAdjParamVal[6];	// 적용값1	
	DWORD	dwChgParamVal[6];	// 적용변화값1
#else
#ifndef __PROP_0827
	DWORD	dwDestParam[2];		// 적용대상1	
