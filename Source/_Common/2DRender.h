...
class C2DRender
{
	...
	LPDIRECT3DSURFACE9		m_pMinimapSurface;
...
public:
...
#if __VER >= 19
	void RenderMiniMap(CTexture *pTexture);
	LPDIRECT3DSURFACE9 GetMinimapSurface(){ return m_pMinimapSurface; }
	...
	BOOL RenderTextureALPHA( CPoint pt, CTexture *pTextureBG, CTexture *pTexture, FLOAT fBlendFactor = 0.0f, FLOAT fScaleX = 1.0f, FLOAT fScaleY = 1.0f );
	void RenderTextureRotateALPHA(CPoint pt, CTexture *pTextureBG, CTexture *pTexture, FLOAT fRadian, FLOAT fIllumination = 0.0f, FLOAT fScaleX = 1.0f, FLOAT fScaleY = 1.0f );
	void RenderTexture_2( CPoint pt, CTexture* pTexture, DWORD dwBlendFactorAlhpa = 255, FLOAT fScaleX = 1.0f, FLOAT fScaleY = 1.0f );
	void RenderTextureNative( CPoint pt, LPDIRECT3DTEXTURE9 pTexture, int nHeight, int nWidth, BOOL bOrigin = FALSE );
	void RenderForMask_Main( CTexture *pTexture, CPoint point, DWORD m_dwAlpha = 255, FLOAT fScaleX = 1.0f, FLOAT fScaleY = 1.0f );
	void RenderForMask_BG( CTexture *pTexture, CPoint point, DWORD m_dwAlpha = 255 );
	LPDIRECT3DTEXTURE9 RenderMergeTextures( CTexture *pTop, CTexture *pBottom, int nWidth, int nHeight, float fPercentageTop = 0.5f );
...
#if __VER >= 19
	void SetTexture( LPDIRECT3DTEXTURE9 pTexture, int nHeight, int nWidth );
#endif // __VER >= 19
...
#if __VER >= 19
	void RenderForMask( LPDIRECT3DDEVICE9 pd3dDevice, TEXTUREVERTEX* pVertices, int nVertexNum );
#endif // __VER >= 19
