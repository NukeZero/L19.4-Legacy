...
//	CD3DFont* m_pFontTextMin;
	...
	CD3DFont* m_pFontWndNewTitle1;
	CD3DFont* m_pFontWndNewTitle2;
#endif // __VER >= 19
...
#if __VER >= 19
	BOOL OnLoadBackground();
	CTexture m_apTextureToolTip[9];
#endif // __VER >= 19
...
#if __VER >= 19
	void RenderWndBaseTitleBar   ( C2DRender* p2DRender, CRect* pRect, LPCTSTR lpszTitle, DWORD dwColor = 0xffffffff );
#else // __VER >= 19
