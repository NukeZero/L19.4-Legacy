...
void CWndDebugInfo::OnDraw(C2DRender* p2DRender)
{
    // Show frame rate
#if __VER >= 19
	p2DRender->TextOut( 2,  0 ,g_Neuz.m_strFrameStats , D3DCOLOR_ARGB( 255, 255, 255, 255 ) );
	p2DRender->TextOut( 2, 20 ,g_Neuz.m_strDeviceStats, D3DCOLOR_ARGB( 255, 255, 255, 255 ) );
#else // __VER >= 19
...
#if __VER >= 19
		p2DRender->TextOut( 2, 40, strDebug, D3DCOLOR_ARGB( 255, 255, 255, 255 ) );
#else // __VER >= 19
...
#if __VER >= 19
		p2DRender->TextOut( 2, 55, strDebug, D3DCOLOR_ARGB( 255, 255, 255, 255 ) );
#else // __VER >= 19
...
#if __VER >= 19
		p2DRender->TextOut( 200, 260, string, D3DCOLOR_ARGB( 255, 255, 255, 255 ) );
#else // __VER >= 19
